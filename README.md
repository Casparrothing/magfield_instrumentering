...
**macOS only:** After plugging in the USB cable, you must manually assign a static IP to the EV3 network interface. Run this in Terminal:

```bash
networksetup -setmanual "EV3+ev3dev" 192.168.2.1 255.255.255.0
```

> **Note:** This command must be re-run every time you replug the USB cable.
